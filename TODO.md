...
- community notes
- agent to tag within X - "add this" 

# ================================================
# NullLabTests Seed AGI Integration Roadmap (2026)
# ================================================
...
## Medium Priority
- [ ] 3D viewer overlay showing "learning potential" heatmaps on each robot part
- [ ] Real-time feed of new supplier announcements filtered for Seed AGI relevance
