# Seed AGI Alignment Reference — Humanoid Atlas

This repo is now officially part of the NullLabTests embodied AGI stack.

Use case examples for your agents:
- Pull the supply-chain graph → feed into SelfImprovingAgent
- Run Groq thesis → pipe output into null-agi-seed-2026 for recursive improvement
- Export JSON for iit-nullab-seeds consciousness scoring on future robot designs
